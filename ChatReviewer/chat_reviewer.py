...
class Reviewer:
    ...
    def stage_1(self, paper):
        ...
        # openai.api_base = self.based_url
        # self.cur_api += 1
        # self.cur_api = 0 if self.cur_api >= len(self.chat_api_list)-1 else self.cur_api
        client = openai.OpenAI(
            api_key=self.api_key,
            base_url=self.based_url,
        )
        messages = [
            {"role": "system",
...
if __name__ == '__main__':    
    ...
    parser.add_argument("--paper_path", type=str, default="./input_file/demo1.pdf", help="path of papers")
    parser.add_argument("--api_key", type=str, default='EMPTY', help="LLM based url")
    parser.add_argument("--based_url", type=str, default='http://localhost:8341/v1', help="LLM based url")
    parser.add_argument("--model_name", type=str, default="Qwen2-7B-Instruct", help="LLM based url")
